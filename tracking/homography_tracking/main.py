...
import sort
import utilities
import homography_tracker as homography_tracker
...
if __name__ == "__main__":
    ...
    parser.add_argument("--video1", type=str, default="./videos/Wildtrack/cam1.mp4")
    parser.add_argument("--video2", type=str, default="./videos/Wildtrack/cam4.mp4")
    parser.add_argument("--homography", type=str, default="./cam1_cam4.npy")
    parser.add_argument(
        "--iou-thres",
        type=float,
        default=0.3,
